...
img_al = MyLabel(frame_al, text="Anterior Left",
                 anchor='center',  width=image_width, height=image_height)
img_pl = MyLabel(frame_pl, text="Posterior Left",
                 anchor='center',  width=image_width, height=image_height)
img_ll = MyLabel(frame_ll, text="Lateral Left",
                 anchor='center',  width=image_width, height=image_height)

img_ar = MyLabel(frame_ar, text="Anterior Right",
                 anchor='center',  width=image_width, height=image_height)
img_pr = MyLabel(frame_pr, text="Posterior Right",
                 anchor='center',  width=image_width, height=image_height)
img_lr = MyLabel(frame_lr, text="Lateral Right",
                 anchor='center', width=image_width, height=image_height)

img_tr = MyLabel(frame_tr, text="Trachea", anchor='center',
